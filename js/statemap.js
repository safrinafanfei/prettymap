...
var div = d3.select("#state_map")
        .append("div")   
        .attr("class", "tooltip")               
        .style("opacity", 0);
// Load in my states data!
d3.csv("data/2014state_fatalinjury.csv", function(data) {
      color.domain([40,55,70,85,110]); // setting the range of the input data
...
// Map the trauma centers!
d3.csv("data/traumacenterlist.csv", function(data) {
